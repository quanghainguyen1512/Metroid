#include "KraidBomerang.h"

KraidBomerang::KraidBomerang() {
	this->isActive = false;
...
KraidBomerang::KraidBomerang(LPD3DXSPRITE spriteHandler, Grid*grid) {
	...
	this->height = SIZE_KRAID_BOMERANG + 10;
}
...
void KraidBomerang::initBullet(float posX, float posY) {
...
void KraidBomerang::Render() {
	...
	this->bomerang->drawSprite(0, 0, SIZE_KRAID_BOMERANG, SIZE_KRAID_BOMERANG, pos);
}

void KraidBomerang::InitSprites(LPDIRECT3DDEVICE9 d3ddv, LPDIRECT3DTEXTURE9 texture) {
	if (d3ddv == NULL) return;
	bomerang = new Sprite(this->spriteHandler, texture, KRAID_BOMERANG_PATH, SIZE_KRAID_BOMERANG, SIZE_KRAID_BOMERANG, COUNT_KRAID_BOMERANG);
}
...
void KraidBomerang::setIsRendered(bool isRendered) {
	this->isRendered = isRendered;
}

bool KraidBomerang::getIsRendered() {
	return this->isRendered;
}

void KraidBomerang::setCount(int count) {
	this->count = count;
}

int KraidBomerang::getCount() {
	return this->count;
}